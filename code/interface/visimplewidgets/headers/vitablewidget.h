...
class ViTableWidget : public QTableWidget
{
	...
	public:
		...
		void setItem(int row, int column, QString text, Qt::Alignment alignment = Qt::AlignLeft | Qt::AlignVCenter);
		void setItem(int row, int column, QWidget *widget, Qt::Alignment alignment = Qt::AlignLeft | Qt::AlignVCenter); //Takes ownership
		void setItem(int row, int column, QTableWidgetItem *item, Qt::Alignment alignment = Qt::AlignLeft | Qt::AlignVCenter); //Takes ownership
