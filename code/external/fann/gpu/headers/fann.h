...
/*Function: fann_setup_descr
 * This function populates a network descriptor.
 * It can be used to create network with advanced configurations.
 */
...
/*Function: fann_setup_layer_descr
 * This function populates a layer descriptor.
 * It can be used to create network with advanced configurations.
 */
...
/*Function: fann_setup_descr
 * This function populates a neuron descriptor.
 * It can be used to create network with advanced configurations.
 */
...
/* Function: fann_create_standard_array_typed
 * Like fann_create_standard but with the possibility of specifying the layer and neuron type using strings
	See also:
		<fann_create_standard_array>, <fann_create_sparse>, <fann_create_shortcut>		
*/
...
/* Function: fann_create_sparse_array_typed
 * Like fann_create_standard but with the possibility of specifying the layer and neuron type using strings
	See also:
		<fann_create_standard_array>, <fann_create_sparse>, <fann_create_shortcut>		
*/
FANN_EXTERNAL struct fann *FANN_API fann_create_sparse_array_typed(const char *layer_type, const char *neuron_type, float connection_rate, unsigned int num_layers, 
															   const unsigned int *layers);
...
FANN_EXTERNAL struct fann *FANN_API fann_create_sparse_array(float connection_rate, 
	                                                         unsigned int num_layers, 
															 const unsigned int *layers);
/* Function: fann_create_from_descr
...
/* Function: fann_create_som
    Creates a Self-Organizing Map

        Example:
                > // Creating a SOM with width of 5 and height of 10
                > struct fann *ann = fann_create_som(5, 10);
...
/* Function: fann_create_gng
     Creates a Growing Neural Gas clusterer

         Example:
               > // Creating a GNG with 3 inputs
               > struct fann *ann = fann_create_gng(3);
...
/* Function: fann_get_total_neurons
   ...
   Get the total number of neurons in the entire network. This number does not include the 
	 bias neurons.
...
/* Function: fann_get_total_layer_neurons

   Get the total number of neurons in the layer. This number does not include the 
   bias neurons.

  This function appears in FANN >= 3.0.0.
*/ 
