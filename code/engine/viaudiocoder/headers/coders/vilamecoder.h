#ifndef VILAMECODER_H
#define VILAMECODER_H

#include <viabstractcoder.h>
#include <visamplesizeconverter.h>
#include <lame.h>

class ViLameCoder : public ViAbstractCoder
{
	...
	protected:
		...
		int seviuentialFrames(QList<int> positions);
	...
	private:
		...
		void (ViLameCoder::*encodePointer)(const void *input, int samples);
