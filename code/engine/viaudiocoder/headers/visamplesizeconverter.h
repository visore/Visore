#ifndef VISAMPLESIZECONVERTER_H
#define VISAMPLESIZECONVERTER_H

#include <vicoder.h>
#include <viaudioformat.h>

class ViSampleSizeConverter
{

	public:

		ViSampleSizeConverter();
		ViSampleSizeConverter(int inputSize, ViAudioFormat::SampleType inputType, int outputSize, ViAudioFormat::SampleType outputType);
		bool initialize(int inputSize, ViAudioFormat::SampleType inputType, int outputSize, ViAudioFormat::SampleType outputType);
