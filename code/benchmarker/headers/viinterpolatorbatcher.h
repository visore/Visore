#ifndef VIINTERPOLATORBATCHER_H
#define VIINTERPOLATORBATCHER_H

#include <viaudioobject.h>
#include <viinterpolator.h>
#include <QTime>

class ViInterpolatorBatcher : public QObject
{
	...
	private slots:
		...
		void setParam(QString name, qreal value);
		bool nextParam();
		void initParams();
